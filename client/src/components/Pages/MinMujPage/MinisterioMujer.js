...
import styles from './MinisterioMujer.module.css'; 

const API_BASE_URL = process.env.REACT_APP_API_URL || 'http://localhost:3001';
const MINISTRY_ID_MUM = 5; // ID del Ministerio de la Mujer (5)

function MinisterioDeLaMujer() {
    ...
    const fetchMinistryFiles = useCallback(async () => {
        ...
        try {
            const token = localStorage.getItem('authToken');
            const response = await axios.get(`${API_BASE_URL}/archivos/ministry/${MINISTRY_ID_MUM}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
            ...
            setFilesError("No se pudieron cargar los archivos del Ministerio de la Mujer. Inténtalo de nuevo más tarde.");
    ...
    return (
        <div className={styles.ministerioDeLaMujerContainer}>
            {/* Sección del Encabezado (HEADER) */}
            <header className={styles.ministerioDeLaMujerHeader}>
                <div className={styles.headerContent}>
                    <h2 className={styles.headerSubtitle}>DEPARTAMENTO</h2>
                    <h1 className={styles.headerTitle}>MINISTERIO DE LA <span>Mujer</span></h1>
                </div>
                {/* Barra de Navegación Interna */}
                <nav className={styles.headerNav}>
                    <ul>
                        <li><a href="#destaque" className={styles.navLink}>DESTAQUE</a></li>
                        <li><a href="#dia-de-oracion" className={styles.navLink}>DÍA DE ORACIÓN</a></li>
            ...
            <div className={styles.resourceContentArea}>
                ...
                <section className={styles.highlightSection} id='destaque'>
                    <h2 className={styles.sectionHeading}>Destaque: Énfasis en el Liderazgo</h2>
                    <div className={styles.highlightCard}>
                        {/* Imagen sugerida: mujeres en un evento o grupo de estudio */}
                        <img src="/Images/MujerPrincipal.jpg" alt="Congreso de Líderes del Ministerio de la Mujer" className={styles.highlightImage} />
                        <div className={styles.highlightDetails}>
                            <h3 className={styles.highlightTitle}>Congreso Anual de Liderazgo Femenino 2025</h3>
                            <p className={styles.highlightDescription}>El liderazgo femenino es vital para la iglesia. Accede a los materiales de estudio de la convención de este año, enfocados en el desarrollo espiritual, la mentoría y el impacto social de las mujeres adventistas.</p>
                            <a href="#" className={styles.highlightLink}>VER MATERIAL <span className={styles.arrowIcon}>&gt;</span></a>
                        </div>
                    </div>
                </section>

                {/* Sección Día de Oración */}
                <section className={styles.categorySection} id='dia-de-oracion'>
                    <h2 className={styles.sectionHeading}>Día Mundial de Oración y Énfasis Femenino</h2>
                    <div className={styles.resourceGrid}>
                        <div className={styles.resourceItem}>
                            <img src="/Images/Oracion.jpg" alt="Recursos para el Día de Oración" className={styles.resourceThumbnail} />
                            <div className={styles.resourceInfo}>
                                <h4 className={styles.resourceTitle}>Guía y Sermón para el Día de Énfasis de la Mujer (2025)</h4>
                                <a href="#" className={styles.resourceLink}>DESCARGAR <span className={styles.arrowIcon}>&gt;</span></a>
                            </div>
                        </div>
                        <div className={styles.resourceItem}>
                            <img src="/Images/Retiro.jpg" alt="Material para Retiro Espiritual" className={styles.resourceThumbnail} />
                            <div className={styles.resourceInfo}>
                                <h4 className={styles.resourceTitle}>Temas para Retiros Espirituales Femeninos</h4>
                                <a href="#" className={styles.resourceLink}>VER TEMAS <span className={styles.arrowIcon}>&gt;</span></a>
                            </div>
                        </div>
                        <div className={styles.resourceItem}>
                            <img src="/Images/Estudio.jpg" alt="Estudio de la Biblia para Mujeres" className={styles.resourceThumbnail} />
                            <div className={styles.resourceInfo}>
                                <h4 className={styles.resourceTitle}>Guías de Estudio Bíblico Profundo para Grupos</h4>
                                <a href="#" className={styles.resourceLink}>VER GUÍAS <span className={styles.arrowIcon}>&gt;</span></a>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <UploadModal
                ...
                preselectedMinistryId={MINISTRY_ID_MUM} 
...
export default MinisterioDeLaMujer;